...
<Callout>
[Note] Capacity is not limited to the Floor price range alone. Capacity can also include the reserve assets available in the Anchor and Discovery price ranges. These reserve assets absorb some of the floating supply, and are also taken into account when calculating the BLV. 
</Callout>
