...
<Tabs items={['📈 BLV', '⚓️ Anchor', '🔎 Discovery']}>
  <Tabs.Tab>
   ...
   BLV is a narrow price range with concentrated liquidity. Think of the Floor as a buy wall for the last bToken holder to exit their position at the [Baseline Value (BLV)](/btokenomics).
