...
more authentic and reliable than what you traditionally see on token screeners and centralized exchanges.
...
to ensure that the liquidity structure can support the outstanding supply. 
In this invariant, `Capacity` is calculated as the total amount of bTokens purchasable across all of the 
protocol-owned liquidity positions. `Circulating Supply` represents the total amount of bTokens purchased from the liquidity pool.
