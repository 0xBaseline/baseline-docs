...
2. **Liquidity rebalancing fees** - the protocol skims some of reserve liquidity during `shift()` liquidity rebalancing. A majority of these reserves go toward increasing the BLV, and a small percent goes to team.
