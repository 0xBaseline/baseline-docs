...
![Sweep](/assets/Sweep.mov)

<Callout>
  :bulb: **Tip:** At high market prices, the sweep() function realizes greater liquidity surpluses, increasing the likelihood of a BLV bump.
</Callout>
...
![Slide](/assets/Slide.mov)

<Callout>
:bulb: **Tip:** Liquidity becomes progressively thinner as the market price approaches the BLV, encouraging greater volatility.
</Callout>
...
![Bump](/assets/Bump.mov)

<Callout>
:bulb: **Tip:** When the BLV price increases, holders can access additional borrowing capacity.
</Callout>
