...
Holders will receive migrated YES tokens on base that will be transfer-locked. 
...
to the Blast transfer-lock of tokens, you will simply be migrated the equivalent spot $YES tokens on 
...
**I'm using a Gnosis Safe on Blast, will the migration work for me?**
Gnosis Safe deployments on Blast are version 1.3.0, which guarantees same address on all chains. If you haven't created
a Gnosis Safe yet on Base, you can do so by following the instructions [here](https://help.safe.global/en/articles/222612-deploying-a-multi-chain-safe#h_f4bdcf79bd).
