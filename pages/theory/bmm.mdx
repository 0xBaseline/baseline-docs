...
## Why it matters
| Feature | Traditional Market Making | Baseline Market Making |
|---------|-------------------------|----------------------|
| Transparency | Off-chain actors, special access, opaque incentives | Fully transparent and algorithmic |
| Value Accrual | Profit-driven spreads that extract value from token holders | Grows with volume—value flows back into the system |
| Growth | Fails under pressure due to human error or conflicting incentives | Designed to scale with market cap |
