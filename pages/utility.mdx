...
- Whenever loans are taken in Baseline, users don't choose the amount to borrow against their collateral; 
the protocol automatically borrows the maximum allowable amount (the full BLV), such that the least amount of collateral
is needed for the liquidity requested by the
