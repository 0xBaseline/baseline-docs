...
The logic of looping just wraps around a loan; instead of giving the underlying liquidity to the borrower, it recursively buys more
tokens until there's no additional capital remains.

Looping is dangerous and users should understand what is happening before they loop.

By looping, users trade off the guarantees of the BLV in exchange for increased exposure to the premium; their returns
are purely based on how much the premium grows

If a bToken with BLV .90c and market price of 1.00 goes to 1.10, the price increased by 10%. Normal spot holdings value increase 10%
looped positions increase 100%, because the premium doubled from 10% to 20%.

Looping is essentially a derivative that allows people to speculate on the shorter term price action

### Funding Decay: "Rebasing"

To simplify the looping experience, Baseline Loop Facility abstracts the process of paying interest or maintaining the position.
