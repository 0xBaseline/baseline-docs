...
Looped positions don't generate direct cash flows to the [Afterburner](/btokenomics/afterburner) for buybacks, but looping still 
...
<Tabs items={['🚀 Benefits', '⚠️ Risks', '🎯 When to Loop', '🔄 How to Loop', '🚪 How to Exit']}>
  ...
  <Tabs.Tab>
    ...
    2. The system automatically max loops your position (creating some specified leverage).
